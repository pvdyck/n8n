...
export class License implements LicenseProvider {
	...
	async init({
		...
		// For unlicensed version, always disable renewal
		const shouldRenew = false;
		...
		try {
			this.manager = new LicenseManager({
				...
				autoRenewEnabled: false, // Disabled for unlicensed version
				renewOnInit: false, // Disabled for unlicensed version
				autoRenewOffset,
	...
	async renew() {
		// Renewal disabled for unlicensed version
		this.logger.debug('License renewal is disabled in unlicensed version');
		return;
	}
	...
	@OnLeaderTakeover()
	enableAutoRenewals() {
		// Auto-renewals disabled for unlicensed version
		this.logger.debug('Auto-renewals are disabled in unlicensed version');
	}
